...
class Client extends Model
{
    ...
    {
        return $this->billings()->where('billings.status', 'paid');
    }
    ...
    {
        return $this->billings()->where('billings.status', '!=', 'paid')->whereDate('billings.due_date', Carbon::today());
    }
    ...
    {
        return $this->billings()->where('billings.status', '!=', 'paid')->where('billings.due_date', '<', Carbon::today());
    }
