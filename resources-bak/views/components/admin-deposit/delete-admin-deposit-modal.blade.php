        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deleteAdminDepositForm" action="" method="DELETE">
                    ...
                    Are you sure you want to delete <span class="adminDepositIdHeader"></span> Admin Deposit?
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" data-bs-dismiss="modal">Cancel</button>
                <button type="submit" class="btn btn-danger" form="deleteAdminDepositForm">Delete Admin
                    Deposit</button>
            </div>
        </div>
    </div>
