@php
    $regions = \App\Models\CourtBranch::select('region')->distinct()->get();
    $courtTypes = \App\Models\CourtBranch::select('type')->distinct()->get();
@endphp
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table id ="courtBranch-list" class="table table-bordered table-hover">
                ...
                success: function(data) {
                    ...
                    if (data.courtBranches.data.length === 0) {
                        ...
                        $.each(data.courtBranches.data, function(index, courtBranch) {
                            $('#courtBranch-list tbody').append(`
                                <tr class="courtBranch-row" data-courtBranch=\'${JSON.stringify(courtBranch).replace(/'/g, '&#39;').replace(/"/g, '&quot;')}\'>
